...
[![Docs](https://img.shields.io/badge/📖_Documentation-Visit-D97757)](https://github.com/miniongk/mimicc)
...
The Claude Code 咪咪 desktop app brings sessions, multi-project navigation, code diffs, permission review, provider setup, scheduled tasks, and IM adapters into one graphical workspace for daily development flows beyond the terminal.
...
<table>
  ...
  <tr>
    ...
    <td align="center" width="33%"><img src="docs/images/desktop_ui/07_im.png" alt="IM Adapters"><br><b>IM Adapters (Telegram / Feishu / WeChat / DingTalk)</b></td>
  </tr>
</table>
