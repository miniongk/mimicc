...
bool cchh_send_user_notification(const char *title, const char *body, char *error_buffer, uintptr_t error_buffer_len) {
    @autoreleasepool {
        ...
        if (@available(macOS 10.14, *)) {
            ...
            content.title = title != NULL ? [NSString stringWithUTF8String:title] : @"Claude Code 咪咪";
        ...
        notification.title = title != NULL ? [NSString stringWithUTF8String:title] : @"Claude Code 咪咪";
        if (body != NULL && strlen(body) > 0) {
