...
Run: `cd /Users/nanmi/workspace/myself_code/claude-code-mimicc/.claude/worktrees/feature-skill-ui && bun build src/server/index.ts --outdir /tmp/skill-check --target bun 2>&1 | tail -5`
...
Run: `cd /Users/nanmi/workspace/myself_code/claude-code-mimicc/.claude/worktrees/feature-skill-ui/desktop && npx tsc --noEmit 2>&1 | tail -5`
...
Run: `cd /Users/nanmi/workspace/myself_code/claude-code-mimicc/.claude/worktrees/feature-skill-ui/desktop && npx tsc --noEmit 2>&1 | tail -10`
...
Run: `cd /Users/nanmi/workspace/myself_code/claude-code-mimicc/.claude/worktrees/feature-skill-ui && bun run src/server/index.ts &`
